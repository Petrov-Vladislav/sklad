    ...
    <body>
        <div id = "wrapper">
			...
			<div class="container mt-4">
                <h3 class="text-info">Поставки</h3>
                <h5 class="mt-4">Сегодня <?php echo "<b>$count_date</b> $str" ?>. Общее количество поставок - <b><?=$count?></b></h5>
			</div>
            <div class="mt-4 container">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add_supply">Заказать поставку</button>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-striped text-center">
                            ...
                            <tbody>
                                <form id="goods_accepted" action="goods_accepted.php" method="post">
                                <?php
                                    for ($i = 0; $i < count($row); $i++) {
                                        ...
                                        echo "<td>".$row[$i]['product_code']."</td>";
                                        echo "<input type='text' name='product_code' value='".$row[$i]['product_code']."' hidden>";
                                        ...
                                        echo "<td><button type='submit' form='goods_accepted' class='btn btn-warning btn-sm'>Товар принят</button></td></tr>";
                                    }
                                ?>
                                </form>
                            </tbody>
            ...
            <!-- Модальное окно с заказом поставки -->
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Новая поставка</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form id="new_supply" action="new_supply.php" method="post">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" form="new_supply" class="btn btn-success">Сохранить</button>
                        </div>
                    </div>
                </div>
            </div>
